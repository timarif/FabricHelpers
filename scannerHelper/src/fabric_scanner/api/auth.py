...
def get_token(
    ...
    *,
    ...
    `runtime_token_provider` is a hook for tests: a callable that takes the
    audience string and returns either a token or None. Production callers
    can ignore it; the Fabric runtime path is tried first.
    """
